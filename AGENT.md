...
**SlipSnap v3.3.2** — десктопное приложение на Python/PySide6 для захвата скриншотов и коротких видео с встроенным редактором. Windows-only. Запускается из трея.
